            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    I have the freedom to develop cutting-edge and significant solutions for learners all around the world as a designer at Scholarnet LMS. Designing the educational landscape of the future is a fascinating endeavor!
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
