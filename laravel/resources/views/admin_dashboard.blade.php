    ...
    <div class="tab-content tab-content-basic">
        ...
        <div class="row">
            ...
            <div class="statistics-details d-flex align-items-center justify-content-between">
                <div>
                <p class="statistics-title">Subscription Rate</p>
                ...
                <div>
                <p class="statistics-title">New Students</p>
                <h3 class="rate-percentage">69</h3>
                <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>68.8</span></p>
                </div>
                <div class="d-none d-md-block">
                <p class="statistics-title">Avg. Time Spent on Site</p>
                <h3 class="rate-percentage">4m:35s</h3>
