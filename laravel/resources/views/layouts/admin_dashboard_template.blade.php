    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">Heading 1</li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#test1" aria-expanded="false" aria-controls="test1">
              <i class="menu-icon mdi mdi-floor-plan"></i>
              <span class="menu-title">Sub-heading 1</span>
